...
export const Sidebar: React.FC<SidebarProps> = ({ currentPage, onNavigate, onLogout }) => {
  ...
  return (
    <aside className={`${isCollapsed ? 'w-20' : 'w-64'} bg-white/90 dark:bg-slate-900/90 backdrop-blur-md text-black dark:text-white flex flex-col shadow-xl flex-shrink-0 border-r border-slate-200 dark:border-white/5 transition-all duration-300`}>
      <div className="p-4 border-b border-slate-200 dark:border-white/10 flex items-center justify-between">
        ...
        <button onClick={toggleSidebar} className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/10 transition-colors">
